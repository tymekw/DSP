...
x = x(bezdzwieczna);               % wybrana g³oska
...
subplot(412);plot(f,X); title('widmo [Hz] //przed preemfaz¹//');
...
subplot(414);plot(f,XPre); title('widmo[Hz] //po//');
...
for  nr = 1 : Nramek
   ...
   % plot(timp,h)
    ...
    Nb=8;       % liczba bitów %8 bez LP ; %10 z ale 16 super
    ...
    if(1)
        figure;                                        % odpowiedŸ czest filra na ramkê
...
if(1) %1 -> nie robie kompresji; 0-> robiê
