...
for  nr = 1 : Nramek
   ...
   % po_progowaniu = [po_progowaniu; bx1]; 
    ...
    % T = 0;  % kropka 1 zawsze bezdzwieczne, szum w sumie to szept
    % T = 0;  %4 jak pociag na torach                                     % usuñ pierwszy znak "%" i ustaw: T = 80, 50, 30, 0 (w celach testowych)
